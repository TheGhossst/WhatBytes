  ...
  if (loading) {
    return (
      <div className="flex-1 p-3 lg:p-4">
        <h1 className="text-xl lg:text-2xl font-bold text-gray-900 mb-4 lg:mb-6">Product Listing</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
        {products.map((product) => (
          ...
          >
            ...
            <h3 className="text-sm font-semibold text-gray-900 mb-1 line-clamp-2 leading-tight">{product.title}</h3>
            ...
            {product.rating && (
              <div className="flex items-center mb-1">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-3 h-3 ${i < product.rating.rate ? "text-yellow-400" : "text-gray-300"}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
